...
require_once($CFG->dirroot . '/mod/stampcoll/backup/moodle2/backup_stampcoll_stepslib.php'); // Because it exists (must)
require_once($CFG->dirroot . '/mod/stampcoll/backup/moodle2/backup_stampcoll_settingslib.php'); // Because it exists (optional)
