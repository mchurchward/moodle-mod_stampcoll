...
/**
 * Define all the restore steps that will be used by the restore_stampcoll_activity_task
 */
...
class restore_stampcoll_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function after_execute() {
        // Add stampcoll related files, no need to match by itemname (just internally handled context)
